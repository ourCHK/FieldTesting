...
public class CallLogUtil {
    ...
    ContentObserver contentObserver = new ContentObserver(new Handler()) {
        ...
        public void onChange(boolean selfChange) {
            ...
            if (logListener != null) {
                ...
                logListener.onChanged(callBean);
            }
        }
    };
    ...
    public CallLogBean getLastCallLog(Context context) {
    ...
    public void start(Context context, String number) {
        ...
        callBean = new OutGoingCallResult();
        try {
    ...
    public interface CallLogListener {
        void onChanged(OutGoingCallResult lastCallLog);
    }
}
