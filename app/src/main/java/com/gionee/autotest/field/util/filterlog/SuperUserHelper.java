...
//	private static UtilLogger log = new UtilLogger(SuperUserHelper.class);
        ...
        try {
            ...
            if (suProcess != null) {
                try {
                    ...
                    Log.i(Constant.TAG, "cannot get pids");
                }
            }
            ...
            Log.i(Constant.TAG, "cannot get process ids");
        }
    ...
    private static void destroyPid(int pid) {
        ...
        try {
            ...
            Log.i(Constant.TAG, "cannot kill process " + pid);
        } finally {
            if (outputStream != null) {
                outputStream.close();
            }
    ...
    public static boolean requestRoot() {
        Log.i(Constant.TAG, "enter request Root");
        ...
        try {
            ...
            Log.i(Constant.TAG, "1Cannot obtain root");
            //showToast(context, R.string.toast_no_root);
            failedToObtainRoot = true;
        } catch (InterruptedException e) {
            Log.i(Constant.TAG, "2Cannot obtain root");
            //showToast(context, R.string.toast_no_root);
            failedToObtainRoot = true;
        }
