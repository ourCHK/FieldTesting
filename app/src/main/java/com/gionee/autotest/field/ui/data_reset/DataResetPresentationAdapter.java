...
public class DataResetPresentationAdapter extends RecyclerView.Adapter<DataResetPresentationAdapter.SelectionTypeHolder> {

    private Context mContext;
    protected OnCustomListener listener;
    private ArrayList<File> dirFileXlsList;

    public DataResetPresentationAdapter(Context mContext, ArrayList<File> dirFileXlsList) {
